...
from views import get_all_employess, get_single_employee, create_employee, delete_employee, update_employee
from views import get_all_customers, get_single_customer, create_customer, delete_customer, update_custoemr
